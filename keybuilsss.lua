...
local Config = {
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/vuh60670-sudo/keybuil/main/keybuil.lua", -- The raw URL of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "buil", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "buil", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "buil.key", -- The main title shown at the top of the GUI
    HubDescription  = "ditme banana hub" -- The text shown below the title
}
